...
import { VoiceP2P } from "./voicechat.client";
...
export default function Room({ id }: Props) {
  ...
  // Keep latest calibrate callback without re-triggering countdown effect
  ...
  return (
    <div className="space-y-6">
      ...
      <div aria-hidden className={calibrated ? "sr-only" : ""}>
